<template>
	<div>
		<el-form :model="formObj" ref="associationRef">
			<el-form-item label="Association table" prop="table" :rules="[{ required: true, message: 'Required Field', trigger: 'blur' }]">
			...
			<el-form-item label="Display fields" prop="field" :rules="[{ required: true, message: 'Required Field', trigger: 'blur' }]">
			...
			<el-form-item label="Storing fields" prop="primarykey" :rules="[{ required: true, message: 'Required Field', trigger: 'blur' }]">
			...
			<el-form-item label="Filter criteria" prop="oldSearchField" :rules="[{ required: true, message: 'Required Field', trigger: 'blur' }]">
