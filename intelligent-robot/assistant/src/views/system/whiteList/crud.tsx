                ...
                url: {
                    ...
                    form: {
                        rules: [
                            ...
                            {
                                required: true,
                                message: 'Interface address is required',
                            },
                        ],
                        component: {
                            span: 24,
                        ...
                        helper: {
                            ...
                            text: 'Please fill it out correctly so that your request will not be blocked. A regular is used to match singletons,For example:/api/xx/.*?/',
                        },
                    },
                },
                enable_datasource: {
