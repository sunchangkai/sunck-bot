<template>
	<fs-page>
		...
		<el-drawer v-model="drawerVisible" title="Dept configuration" direction="rtl" size="500px" :close-on-click-modal="false" :before-close="handleDrawerClose">
			<DeptFormCom
				v-if="drawerVisible"
...
const handleDeleteMenu = (id: string, callback: Function) => {
	ElMessageBox.confirm('Are you sure to delete this department?', 'Tips', {
