<template>
	<el-form ref="formRef" :rules="rules" :model="deptFormData" label-width="100px" label-position="right" class="dept-form-com">
		<el-form-item label="Parent dept" prop="parent">
			<el-tree-select
		...
		<el-form-item required label="Dept name" prop="name">
			<el-input v-model="deptFormData.name" />
		</el-form-item>
		<el-form-item required label="Dept key" prop="key">
...
const rules = reactive<FormRules>({
	...
	key: [{ required: true, message: 'Department key is required', trigger: 'blur' }],
});
