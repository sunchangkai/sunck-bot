<template>
	<el-input v-model="filterVal" :prefix-icon="Search" placeholder="Please enter menu name" />
	<div class="menu-tree-com">
		<div class="mtc-head">
			...
			<el-tooltip
				effect="dark"
				placement="right"
				content="1.The red menu means the status is disabled; 2.Add a menu, if it is a directory, the component address is empty; 3.Add the root menu with an empty parent ID; 4.Supports drag and drop menus;"
			>
		...
		<div class="mtc-tags">
			<el-tooltip effect="dark" content="Add">
